...
export function humanizeTextInstruction(body) {
  return JSON.stringify({
    ...
    rules: [
      ...
      "Перед возвратом проверь attentionReview: понятен ли контекст за 2 секунды, нет ли экспертного жаргона, названа ли конкретная боль и звучит ли headline естественно. Если нет — перепиши headline и subhead целиком.",
      ...clickbaitHeadlineRules,
      ...simpleAudienceLanguageRules,
      ...viralReelsHookRules,
      ...hookPayoffRules,
