...
export async function createCompositeAvatarVideo({ avatarVideoUrl, backgroundImageUrl, audioData = "" }) {
  return createKieTask("/api/avatar-videos/composite", { avatarVideoUrl, backgroundImageUrl, audioData });
}
