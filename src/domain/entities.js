...
export const products = [
  {
    ...
    useCases: ["вечером трудно остановиться после перегруза", "утром нет ощущения, что сон восстановил", "хочется один спокойный ритуал вместо хаотичных советов"],
    proofPoints: ["вечерний формат приема", "ставка на привычку и регулярность, а не на чудо-эффект", "понятный состав без агрессивных обещаний"],
    visualAnchors: ["стакан воды на тумбочке", "вечерний ритуал перед сном", "спокойный свет, книга, вода, капсула"],
  ...
  },
  {
    ...
    useCases: ["тратите на уход, а кожа все равно выглядит уставшей", "нет одной понятной beauty-привычки на каждый день", "хочется поддерживать внешний вид без громких обещаний"],
    proofPoints: ["ежедневный формат", "понятное сочетание коллагена и витамина C", "делаем акцент на регулярность, а не на магию"],
    visualAnchors: ["утренний напиток", "банка на столе рядом с уходом", "ложка порошка, стакан, чистая beauty-рутина"],
  ...
  },
  {
    ...
    useCases: ["после длинного дня кожа выглядит уставшей", "банок много, а рутина все еще хаотичная", "хочется один понятный вечерний шаг"],
    proofPoints: ["пептиды в составе", "вечерний формат ухода", "результат зависит от регулярности и типа кожи"],
    visualAnchors: ["вечерний уход у зеркала", "сыворотка в руке", "чистая полка, мягкий свет, капля средства"],
  ...
  },
  {
    ...
    useCases: ["подписка отключается сегодня", "рабочий сервис завис из-за оплаты", "нужно быстро понять, какой маршрут оплаты безопаснее"],
    proofPoints: ["проверка сценария перед оплатой", "сопровождение и прозрачная коммуникация", "без серых обещаний и магических гарантий"],
    visualAnchors: ["экран отказа оплаты", "таймер подписки", "чат поддержки, invoice, карта, сервисный интерфейс"],
