...
export const socialSafeZoneRules = [
  ...
  "Нижняя безопасная зона: нижние 22-28% кадра должны оставаться спокойным фоном без мелкого текста, карточек и важных деталей, чтобы видео-оверлей, комментарии и CTA не перекрывали смысл.",
