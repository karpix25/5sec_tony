...
export const russianImageTextRules = [
  ...
  "Заменяй любые английские слова, заголовки и латиницу: переведи смысл на русский, включая UI labels (Subscribe, Payment, Error и т.д.).",
...
export const socialSafeZoneRules = [
  "ТЕХНИЧЕСКАЯ SAFE ZONE: это инструкция для композиции, не видимый текст; никогда не писать и не рисовать на финальной картинке координаты, x=, y=, top UI, bottom caption. Все важные элементы держать внутри x=72..820 и y=190..1360; top UI y=0..190, right action rail x=820..1024. Нижние 24% кадра оставить чистыми: без кнопки, без CTA, без дисклеймера, без продукта; адаптировать композицию под safe zone.",
