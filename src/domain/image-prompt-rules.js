...
export const contentQualityRules = [
  ...
  "ЗАГОЛОВОК В БЕЗОПАСНОЙ ЗОНЕ: 5–8 слов и максимум 48 символов, одна законченная мысль, без двоеточий и без второй строки-объяснения внутри заголовка. Если исходная фраза не помещается, перепиши её целиком; не обрезай программно.",
