...
export const russianImageTextRules = [
  ...
  "Заменяй любые английские слова, заголовки, латиницу, псевдолатинский текст и интерфейсные ярлыки на понятные русские аналоги.",
  "Обязательно адаптируй и переводи англоязычные исходники, референсы и PDF-хуки на качественный русский язык перед размещением.",
...
export const socialSafeZoneRules = [
  ...
  "Верхняя безопасная зона: y=0..280 должен оставаться пустым спокойным фоном без любого текста, заголовка, иконок, продукта или важных деталей.",
