...
export const russianImageTextRules = [
  "ЯЗЫК НА ИЗОБРАЖЕНИИ: весь редакционный текст инфографики — это добавляемый текст; он должен быть строго на русском языке.",
  "Весь добавляемый редакционный текст инфографики строго на русском языке; используй понятные русские аналоги вместо английских слов, псевдолатинского текста и интерфейсных ярлыков.",
  "Англоязычные исходники, референсы и PDF-хуки адаптируй на качественный русский только в добавляемом редакционном тексте.",
  ...
  "Официальные названия брендов и сервисов можно оставить латиницей (внутри текста, а не как самостоятельные заголовки или CTA)."
];
...
export const socialSafeZoneRules = [
  ...
  "Верхняя безопасная зона: y=0..360 должен оставаться пустым спокойным фоном без любого текста, заголовка, иконок, продукта или важных деталей.",
  "Нижняя безопасная зона: y=1300..1920 и нижние 30% кадра должны оставаться пустым спокойным фоном без любого текста, даже мелкого дисклеймера.",
  "Запрещено касание краев: никакие карточки, круги, стрелки, текстовые строки, продукт или декоративные дуги не должны обрезаться левым, правым, верхним или нижним краем.",
  "Оставляй широкие пустые поля (minimalist margins) сверху и снизу, чтобы элементы интерфейса соцсетей не перекрывали контент.",
  "Сделай щедрый отступ (clear padding) с правого края кадра — там традиционно располагаются кнопки лайков и комментариев.",
  "Размещай весь смысловой контент (текст, карточки, главный объект) ближе к центру (center-aligned vertical composition).",
  "Нижняя четверть кадра должна оставаться полностью чистой и служить просто фоном.",
  "Если дизайн-референс прижимает важный текст или продукт к краям, смести их в центральную зону кадра, бережно сохранив исходный визуальный стиль."
];
...
export const contentQualityRules = [
  ...
  "ЗАГОЛОВОК В БЕЗОПАСНОЙ ЗОНЕ: 3–6 слов и максимум 34 символа, одна законченная мысль, без двоеточий и второй фразы внутри заголовка.",
  "Заголовок должен целиком помещаться максимум в две крупные строки. Нельзя обрезать слова или фразу краем кадра; при нехватке места уменьши кегль в рамках иерархии референса.",
  ...
  "Заголовок и видимый текст писать буквально: без метафор, образных замен и сложных объяснений. Не уводить тему в случайные объекты вроде кофемашины, телефона или батарейки, если связь с продуктом и болью не очевидна за одну строку.",
