...
const essentialPromptPatterns = [
  ...
  /ближе к центру/i,
  /щедрый отступ.*правого края/i,
  /широкие пустые поля/i,
  /Запрещено касание краев/i,
  /Верхняя безопасная зона: y=0\.\.360/i,
  /смести их в центральную зону кадра/i,
  /Нижняя четверть кадра.*чистой/i,
  /remap\/scale\/shift/i,
