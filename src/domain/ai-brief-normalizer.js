...
export function normalizeAiBrief(draft = {}, diversitySlot = {}) {
  ...
  return {
    ...
    sourceHook: cleanDraft.sourceHook || hook,
    ...
    topicSelection: cleanDraft.topicSelection || null,
    ...
    semanticKey: cleanDraft.topicSelection?.id || cleanSlot.id || cleanDraft.semanticKey,
