...
export const safeZoneReferenceRules = [
  "SAFE ZONE REFERENCE: среди input images есть служебная 9:16 маска размещения; это последний служебный референс только для границ размещения, не дизайн-референс, не палитра, не фон и не источник композиционного стиля.",
