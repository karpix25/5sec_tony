...
function hasSpecificity(text) {
  return /япони|итал|рим|сингапур|дуба|оаэ|таиланд|франц|турци|гиалурон|коллаген|пептид|магни|витамин|чаев|капучино|эспрессо|влажн|крем|стакан|зел[её]н|карта|подписк|инвойс|счет|бронь|сервис|валют|статус|подтвержден|кофе|экран|свет|сон/.test(text);
}
...
function hasNovelty(text) {
  ...
  return /факт|оказалось|неожидан|почему|в японии|в италии|в сингапуре|в таиланде|во франции|в оаэ|гиалуроновая кислота|хлорофилл|магний|витамин|коллаген|инвойс|подписка|бронь|страна карты|тип карты|статус заявки|патч-тест|пептид|поздний кофе|яркий экран|хаотичн.*сон/.test(text);
}
