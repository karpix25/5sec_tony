...
const unsupportedClaimPatterns = [
  ...
  ["causal_certainty", /(?:главн|скрыт|прям).{0,16}причин|напрямую\s+влияет|зависит\s+от|дело\s+в|из\s+за|указывает\s+на.{0,20}дефицит|требу(?:ет|ют).{0,24}(?:белк|жирн|витамин|минерал)|связан.{0,24}(?:дискомфорт|проблем|наруш|бол)|привычк.{0,24}(?:не\s+закреп|формиру|складыва)/iu],
  ...
  ["numeric_detail", /\d+(?:[.,]\d+)?(?:\s+\d+(?:[.,]\d+)?)?\s*(?:кап(?:л|ел)|минут|час|дн|недел|месяц|мг|мл|кг|г|%)/iu],
...
export const claimEvidenceRules = [
  ...
  "Боли, сценарии и objections помогают выбрать тему, но не являются доказательствами причин, физиологии или эффекта продукта.",
